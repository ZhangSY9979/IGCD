...
class VAE_kmeans(torch.nn.Module):
    def __init__(self, input_dim=784, hidden_dims=[800, 500], latent_dim=100, n_classes=10):
        ...
        self.kmeans_mean = nn.Parameter(torch.randn(n_classes, latent_dim))
    ...
    def forward(self, x):
        ...
        x_hat = self.decode(z)
        return x_hat, mu, log_var, z, self.kmeans_mean
