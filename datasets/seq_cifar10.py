...
class SequentialCIFAR10(IncrementalDataset):
    ...
    def get_data_loaders(self):
        ...
        train_dataset = MyCIFAR10(self.args.root + 'CIFAR10', train=True, transform=self.train_transform)
        if self.args.validation:
            train_dataset, test_dataset = get_train_val(train_dataset,
                                                        self.test_transform, self.NAME)
        else:
            test_dataset = MyCIFAR10(self.args.root + 'CIFAR10', train=False, transform=self.test_transform)
    ...
    def not_aug_dataloader(self, batch_size):
        ...
        train_dataset = MyCIFAR10(self.args.root + 'CIFAR10', train=True, transform=transform)
